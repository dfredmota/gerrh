...
angular.module('mgcrea.ngStrap.tab').run(['$templateCache', function($templateCache) {
  $templateCache.put('tab/tab.tpl.html', '<ul tabindex="-1" class="dropdown-menu" role="menu"><li role="presentation" ng-class="{divider: item.divider}" ng-repeat="item in content.dpdown" ><a role="menuitem" href="javascript:void(0);" tabindex="-1" ng-if="!item.divider" ng-click="Data.newTab(item.href)" ><span ng-class="item.icon"></span>&nbsp;{{item.label}}</a></li></ul>');
